...
> Run a full-featured RxDB NoSQL database on top of Deno Key Value Store with queries, encryption, compression, and replication support across 35 global regions.
