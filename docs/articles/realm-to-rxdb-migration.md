...
> Migrate a Realm application to RxDB step by step. Map object schemas to JSON schemas, translate Realm Query Language, move existing data and replace Atlas Device Sync with open replication.
