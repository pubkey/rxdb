# IndexedDB Sync - Replicate Browser Data Across Tabs, Devices and Servers

> Learn how to sync IndexedDB across browser tabs, devices, and a backend server. Compare sync approaches and see how RxDB adds realtime replication.
