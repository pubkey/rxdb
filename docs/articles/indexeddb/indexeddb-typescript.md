# IndexedDB with TypeScript - Type-Safe Browser Storage

> Use IndexedDB with TypeScript and get full type safety. Compare typing the native API, idb, and schema-derived types with RxDB.
