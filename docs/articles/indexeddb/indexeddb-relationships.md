# IndexedDB Relationships - Modeling Relations in the Browser

> IndexedDB has no joins and no foreign keys. Learn how to model one-to-many and many-to-many relations with indexes, junction stores, and RxDB references.
