# Best IndexedDB Wrapper - Compare Dexie, idb, localForage, PouchDB and RxDB

> Compare the best IndexedDB wrappers for JavaScript. Features, performance, and a feature table for Dexie, idb, localForage, PouchDB, LokiJS and RxDB.
