# IndexedDB Query - How Querying Works, Indexes, and Limits

> Learn how an IndexedDB query works with key ranges and cursors, how the right index speeds it up, where it falls short, and how RxDB adds NoSQL queries.
