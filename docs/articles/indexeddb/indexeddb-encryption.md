# IndexedDB Encryption - How to Encrypt Data Stored in IndexedDB

> IndexedDB is not encrypted at rest. Learn how IndexedDB encryption works, why the raw API cannot do it, and how RxDB encrypts fields on top of IndexedDB.
