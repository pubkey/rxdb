# Local Database - What It Is and How to Use One in JavaScript

> A local database stores data on the user's device for instant queries and offline access. Learn how local databases work and how to use one in JavaScript.
