# What Is a Realtime Database? Definition, Replication and Limits

> A realtime database pushes changes to clients instead of letting them poll. Learn the three meanings of realtime and where hosted realtime databases fall short.
