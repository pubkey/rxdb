...
> Need a stable ElectricSQL alternative? RxDB is a local-first JavaScript database with full read and write replication, observable queries, and a flexible backend.
