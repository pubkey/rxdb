...
> Replace MongoDB Realm and Atlas Device SDK with RxDB, a JavaScript local-first database with offline support, reactive queries, and flexible replication.
