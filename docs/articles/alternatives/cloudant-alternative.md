...
> Replace PouchDB with RxDB on the client while keeping Cloudant or any CouchDB-compatible backend. Faster local storage, reactive queries, less lock-in.
