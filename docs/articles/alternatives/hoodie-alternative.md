...
> Replace unmaintained Hoodie with RxDB. Keep CouchDB sync, gain TypeScript, reactive queries, multi-tab support, and modern offline-first JavaScript tooling.
