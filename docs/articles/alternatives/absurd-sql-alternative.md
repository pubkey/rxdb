...
> Looking beyond absurd-sql? RxDB offers schema validation, observable queries, replication, and pluggable storages like OPFS, IndexedDB, and SQLite without low-level SQL plumbing.
