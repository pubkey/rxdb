# Offline-First Database for DDIL Environments - Sync Without a Network

> In DDIL environments the network is denied, disrupted, intermittent, or limited. Learn how an offline-first database like RxDB keeps your app usable.
