...
> Supabase realtime needs a network connection. Add offline-first durability to TanStack DB with RxDB as a local store that replicates to Supabase Postgres.
