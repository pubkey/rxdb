...
> Give your Electron app a reactive, offline-first data layer. Pair TanStack DB's live queries with RxDB for durable local storage and backend sync on desktop.
