...
> Make TanStack DB survive reloads and long offline stretches. Use RxDB for durable local-first persistence and replication that resumes once you're back online.
