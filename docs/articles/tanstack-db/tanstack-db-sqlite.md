...
> Back TanStack DB with SQLite, native on React Native, Node and Electron, or WASM in the browser, using RxDB's SQLite storage for durable, syncable local data.
