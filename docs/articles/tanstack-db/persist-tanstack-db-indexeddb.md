...
> TanStack DB is in-memory by default. Persist it to durable browser storage, IndexedDB or OPFS, using RxDB as a storage-agnostic collection backend.
