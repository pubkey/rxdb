...
> TanStack DB handles optimistic rollback but delegates server-side conflict resolution. Learn how RxDB's conflict handler resolves offline sync conflicts.
