...
> Sync TanStack DB directly between devices with no central server, using RxDB's WebRTC replication. Build peer-to-peer, local-first apps with live queries.
