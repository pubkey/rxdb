# Electron SQLite Database - Reactive Local Data with RxDB

> Use SQLite in Electron the right way. Run the database in the main process with RxDB on top and get reactive queries, encryption and realtime sync in your desktop app.
