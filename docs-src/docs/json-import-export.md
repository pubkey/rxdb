...
slug: json-import-export.html
description: Export an RxDB database or collection into a plain JSON dump and import it back with the json-dump plugin, including attachments as base64.
image: /headers/json-import-export.jpg
---
