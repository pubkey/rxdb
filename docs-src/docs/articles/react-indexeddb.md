---
title: Using IndexedDB in React - RxDB on Top of IndexedDB Simplifies Your Database
...
# Using IndexedDB in React: RxDB on Top of IndexedDB Simplifies Your Database
