...
image: /headers/embedded-database.jpg
---

# Using RxDB as an Embedded Database

<ArticleByline published="2023-06-16" />
...
- Replicating the database state becomes easier: Implementing real-time data synchronization and [replication](../replication.md) is simpler with an embedded database compared to complex REST routes. The embedded nature allows for efficient replication of the database state across multiple instances of the application.
