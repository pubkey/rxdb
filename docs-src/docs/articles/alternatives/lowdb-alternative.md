...
The numbers reflect this. As of July 30, 2026, [LowDB](https://github.com/typicode/lowdb) has 22,567 GitHub stars while [RxDB](https://github.com/pubkey/rxdb) has 23,296. The last commit to the [LowDB repository](https://github.com/typicode/lowdb) was in March 2026, <TimeSince date="2026-03-27" />.
