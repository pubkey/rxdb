...
- **ADD** [Flutter Plugin](../flutter-database.md) improvements: `findOne()`, `bulkInsert()`, `bulkRemove()`, `upsert()`, `count()`, `patch()`, `incrementalPatch()`, `incrementalRemove()`, `RxDatabase.close()`, and multi-database support.
