    ...
    Object.keys(plugins)
        ...
        .forEach((pluginPath) => {
            ...
            const pluginPackageContent = {
                ...
                'main': '../../dist/lib/' + pluginFolderName + 'index.js',
                'module': '../../dist/es/' + pluginFolderName + 'index.js',
                'es2015': '../../dist/es/' + pluginFolderName + 'index.js',
                'jsnext:main': '../../dist/es/' + pluginFolderName + 'index.js',
