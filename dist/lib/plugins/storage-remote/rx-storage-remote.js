...
var RxStorageRemote = /*#__PURE__*/function () {
  ...
  _proto.createStorageInstance = function createStorageInstance(params) {
    try {
      ...
      var waitForOkPromise = (0, _rxjs.firstValueFrom)(_this.settings.messages$.pipe((0, _rxjs.filter)(function (msg) {
...
var RxStorageInstanceRemote = /*#__PURE__*/function () {
  ...
  _proto2.requestRemote = function requestRemote(methodName, params) {
    try {
      ...
      var responsePromise = (0, _rxjs.firstValueFrom)(_this3.messages$.pipe((0, _rxjs.filter)(function (msg) {
        return msg.answerTo === requestId;
      })));
      var message = {
