 ...
 */
function createRevisionForPulledDocument(replicationIdentifier, doc) {
  var replicationIdentifierHash = (0, _util.hash)(replicationIdentifier);
  var dataHash = (0, _util.hash)(doc);
  var ret = dataHash.substring(0, 8) + replicationIdentifierHash.substring(0, 30);
  return ret;
}

function wasRevisionfromPullReplication(replicationIdentifier, revision) {
  var replicationIdentifierHash = (0, _util.hash)(replicationIdentifier);
