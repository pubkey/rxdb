...
var RxReplicationStateBase = /*#__PURE__*/function () {
  ...
  _proto.run = function run() {
    try {
      ...
      if (_this7.runQueueCount > 2) {
        return Promise.resolve(_this7.runningPromise);
      }

      _this7.runQueueCount++;
      _this7.runningPromise = _this7.runningPromise.then(function () {
        _this7.subjects.active.next(true);

        return _this7._run(retryOnFail);
      }).then(function (willRetry) {
        _this7.subjects.active.next(false);

        if (retryOnFail && !willRetry && _this7.subjects.initialReplicationComplete.getValue() === false) {
          _this7.subjects.initialReplicationComplete.next(true);
        }

        _this7.runQueueCount--;
      });

      if (_this7.live && _this7.pull && _this7.liveInterval > 0 && _this7.pendingRetries < 1) {
        _this7.runningPromise.then(function () {
          return _this7.continuePolling();
        });
      }
      ...
      var _temp7 = function _temp7() {
        ...
        var addRetry = function addRetry() {
          if (_this11.pendingRetries < 1) {
            ...
            _this11.collection.promiseWait((0, _util.ensureNotFalsy)(_this11.retryTime)).then(function () {
              _this11.pendingRetries = _this11.pendingRetries - 1;
  ...
  _proto.runPull = function runPull() {
    try {
      ...
      return Promise.resolve((0, _replicationCheckpoint.getLastPullDocument)(_this13.collection, _this13.replicationIdentifierHash)).then(function (latestDocument) {
        var _exit3 = false;
              ...
              function _temp13(_result5) {
                ...
                var _temp10 = function () {
                  if (pulledDocuments.length === 0) {
                    ...
                    return Promise.resolve((0, _replicationCheckpoint.setLastPullDocument)(_this13.collection, _this13.replicationIdentifierHash, newLatestDocument)).then(function () {
                      var _temp9 = function () {
  ...
  _proto.runPush = function runPush() {
    try {
      ...
      return Promise.resolve((0, _replicationCheckpoint.getChangesSinceLastPushCheckpoint)(_this15.collection, _this15.replicationIdentifierHash, function () {
        ...
        function _temp19(_result6) {
          ...
          return _this15.isStopped() ? true : Promise.resolve((0, _replicationCheckpoint.setLastPushCheckpoint)(_this15.collection, _this15.replicationIdentifierHash, changesResult.checkpoint)).then(function () {
