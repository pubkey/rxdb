...
var _mainUtils = require("./main-utils");
...
function getInMemoryFields(coreInMemoryFields, index, selector, userFields) {
  var result = (0, _mainUtils.flatten)( // in-memory fields reported as necessary by the query planner
  ...
  return sortFieldsByIndex((0, _mainUtils.uniq)(result), index);
...
function checkIndexFieldsMatch(indexFields, sortOrder, fields) {
  if (sortOrder) {
    ...
    var sortMatches = (0, _mainUtils.oneArrayIsStrictSubArrayOfOther)(sortOrder, indexFields);
    var selectorMatches = (0, _mainUtils.oneArrayIsSubArrayOfOther)(fields, indexFields);
  ...
  return (0, _mainUtils.oneSetIsSubArrayOfOther)(fields, indexFields);
}
...
function findBestMatchingIndex(selector, userFields, sortOrder, indexes, useIndex) {
  ...
  var userFieldsMap = (0, _mainUtils.arrayToObject)(userFields);
  ...
  return (0, _mainUtils.max)(matchingIndexes, scoreIndex);
}
...
function getSingleFieldCoreQueryPlan(selector, index) {
  ...
  userOperators.forEach(function (userOperator) {
    ...
    if (combinedOpts) {
      combinedOpts = (0, _mainUtils.mergeObjects)([combinedOpts, newQueryOpts]);
    } else {
...
function getMultiFieldQueryOpts(selector, index) {
  ...
  for (var i = 0, len = indexFields.length; i < len; i++) {
    ...
    if (!matcher || !Object.keys(matcher).length) {
      ...
      var previousWasEq = (0, _mainUtils.arrayEquals)(previousKeys, ['$eq']);
      var previousWasSame = (0, _mainUtils.arrayEquals)(previousKeys, Object.keys(matcher));
    ...
    for (var j = 0; j < userOperators.length; j++) {
      ...
      if (combinedOpts) {
        combinedOpts = (0, _mainUtils.mergeObjects)([combinedOpts, newOpts]);
      } else {
...
function planQuery(request, indexes) {
  ...
  var userFieldsRes = (0, _utils.getUserFields)(selector, sort);
