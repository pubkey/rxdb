...
var RxStorageInstanceFoundationDB = /*#__PURE__*/function () {
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            return dbs.root.doTransaction( /*#__PURE__*/function () {
              var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(tx) {
  ...
  _proto.findDocumentsById = /*#__PURE__*/function () {
    var _findDocumentsById = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(ids, withDeleted) {
      var dbs;
        ...
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 2:
            ...
            return _context6.abrupt("return", dbs.main.doTransaction( /*#__PURE__*/function () {
              var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(tx) {
                var ret;
                return _regenerator["default"].wrap(function _callee5$(_context5) {
                  while (1) switch (_context5.prev = _context5.next) {
                    case 0:
                      ...
                      _context5.next = 3;
                      return Promise.all(ids.map( /*#__PURE__*/function () {
                        var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(docId) {
                          var docInDb;
  ...
  _proto.count = /*#__PURE__*/function () {
    var _count = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(preparedQuery) {
      var result;
  ...
  _proto.getAttachmentData = /*#__PURE__*/function () {
    var _getAttachmentData = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(documentId, attachmentId) {
      var dbs, attachment;
      return _regenerator["default"].wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          ...
          case 2:
            dbs = _context8.sent;
            _context8.next = 5;
            return dbs.attachments.get((0, _storageMemory.attachmentMapKey)(documentId, attachmentId));
          case 5:
  ...
  _proto.getChangedDocumentsSince = /*#__PURE__*/function () {
    var _getChangedDocumentsSince = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee10(limit, checkpoint) {
      ...
      return _regenerator["default"].wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            indexName = (0, _foundationdbHelpers.getFoundationDBIndexName)(index);
            ...
            _context10.next = 11;
            return dbs.root.doTransaction( /*#__PURE__*/function () {
              var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(tx) {
                ...
                return _regenerator["default"].wrap(function _callee9$(_context9) {
                  while (1) switch (_context9.prev = _context9.next) {
                    case 0:
                      ...
                      mainTx = tx.at(dbs.main.subspace);
                      _context9.next = 5;
                      return indexTx.getRangeAll(keySelector.firstGreaterThan(lowerBoundString), _queryPlanner.INDEX_MAX, {
                        limit: limit,
  ...
  _proto.cleanup = /*#__PURE__*/function () {
    var _cleanup = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee13(minimumDeletedTime) {
      var _this2 = this;
      ...
      return _regenerator["default"].wrap(function _callee13$(_context13) {
        while (1) switch (_context13.prev = _context13.next) {
          ...
          case 4:
            dbs = _context13.sent;
            index = _foundationdbHelpers.CLEANUP_INDEX;
            indexName = (0, _foundationdbHelpers.getFoundationDBIndexName)(index);
            indexMeta = dbs.indexes[indexName];
            lowerBoundString = (0, _customIndex.getStartIndexStringFromLowerBound)(this.schema, index, [true,
            /**
             * Do not use 0 here,
             * because 1 is the minimum value for _meta.lwt
             */
            1], false);
            upperBoundString = (0, _customIndex.getStartIndexStringFromUpperBound)(this.schema, index, [true, maxDeletionTime], true);
            noMoreUndeleted = true;
            _context13.next = 13;
            return dbs.root.doTransaction( /*#__PURE__*/function () {
              var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee12(tx) {
...
function createFoundationDBStorageInstance(storage, params, settings) {
  ...
  var dbsPromise = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee15() {
