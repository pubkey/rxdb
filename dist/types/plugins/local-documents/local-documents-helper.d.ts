import type { LocalDocumentParent, LocalDocumentState, RxJsonSchema, RxLocalDocumentData, RxStorage } from '../../types';
...
export declare const RX_LOCAL_DOCUMENT_SCHEMA: RxJsonSchema<RxLocalDocumentData>;
