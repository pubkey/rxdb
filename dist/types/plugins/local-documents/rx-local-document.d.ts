...
export declare function getRxDatabaseFromLocalDocument(doc: RxLocalDocument<any> | RxLocalDocumentClass): RxDatabase<import("../../types/rx-database").CollectionsOfDatabase, any, {}, any> | import("../../rx-database.ts").RxDatabaseBase<any, any, any, any>;
export {};
