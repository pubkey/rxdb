 ...
 */
oldDatabaseName: string, oldStorage: RxStorageOld<any, any>, batchSize?: number, afterMigrateBatch?: AfterMigrateBatchHandler, logFunction?: (message: string) => void): Promise<void>;
