...
export declare type InWorkerStorage<RxDocType> = {
    createStorageInstance(params: RxStorageInstanceCreationParams<RxDocType, any>): Promise<number>;
    bulkWrite(instanceId: number, documentWrites: BulkWriteRow<RxDocType>[]): Promise<RxStorageBulkWriteResponse<RxDocType>>;
    ...
    getChangedDocumentsSince(instanceId: number, limit: number, checkpoint: any): Promise<{
        document: RxDocumentData<RxDocType>;
        checkpoint: any;
    }[]>;
    changeStream(instanceById: number): Observable<EventBulk<RxStorageChangeEvent<RxDocumentData<RxDocType>>>>;
