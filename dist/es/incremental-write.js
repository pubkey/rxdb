...
import { clone, ensureNotFalsy, getFromMapOrFill, getFromMapOrThrow, parseRevision, stripMetaDataFromDocument } from './util';
/**
...
export var IncrementalWriteQueue = /*#__PURE__*/function () {
  ...
  _proto.addWrite = function addWrite(lastKnownDocumentState, modifier) {
    ...
    var ar = getFromMapOrFill(this.queueByDocId, docId, function () {
      return [];
    });
  ...
  _proto.triggerRun = /*#__PURE__*/function () {
    var _triggerRun = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      var _this2 = this;
          ...
          case 18:
            ...
            Array.from(Object.entries(writeResult.error)).forEach(function (_ref4) {
              ...
              if (isConflict) {
                ...
                var ar = getFromMapOrFill(_this2.queueByDocId, docId, function () {
                  return [];
                });
                /**
...
export function modifierFromPublicToInternal(publicModifier) {
  var ret = /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(docData) {
      var withoutMeta, modified, reattachedMeta;
      return _regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            withoutMeta = stripMetaDataFromDocument(docData);
