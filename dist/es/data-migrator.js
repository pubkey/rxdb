...
var OldCollection = function () {
     ...
     * @return {Promise}
     */
    OldCollection.prototype.countAllUndeleted = function countAllUndeleted() {
    ...
    OldCollection.prototype.migrate = function migrate() {
        ...
        var stateStream$ = new Observable(function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(observer) {
                var batch, error;
