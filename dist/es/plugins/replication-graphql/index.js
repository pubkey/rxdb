        ...
        return Promise.resolve(_this7.pull.queryBuilder(latestDocumentData)).then(function (pullGraphQL) {
          ...
          var _temp9 = _catch(function () {
            return Promise.resolve(_this7.client.query(pullGraphQL.query, pullGraphQL.variables)).then(function (_this6$client$query) {
              ...
              if (result.errors) {
                if (typeof result.errors === 'string') {
                  throw new RxReplicationError(result.errors, {
                    type: 'pull'
                  });
                } else {
                  throw new RxReplicationError('unknown errors occurred in replication pull - see innerErrors for more details', {
                    type: 'pull'
                  }, result.errors);
                }
              }
            ...
            if (!(err instanceof RxReplicationError)) {
              replicationError = new RxReplicationError(err.message, {
                type: 'pull'
              }, err);
            }
