...
export var RxStorageInstanceDexie = /*#__PURE__*/function () {
  ...
  _proto.bulkWrite = /*#__PURE__*/function () {
    var _bulkWrite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(documentWrites, context) {
      var _this = this;
              ...
              return _regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    docsInDbMap = new Map();
                    _context.next = 3;
                    return getDocsInDb(_this.internals, documentKeys);
                  case 3:
                    ...
                    return Promise.all([bulkPutDocs.length > 0 ? state.dexieTable.bulkPut(bulkPutDocs.map(function (d) {
                      ...
                      return fromStorageToDexie(d);
                    })) : PROMISE_RESOLVE_VOID, bulkRemoveDeletedDocs.length > 0 ? state.dexieDeletedTable.bulkDelete(bulkRemoveDeletedDocs) : PROMISE_RESOLVE_VOID]);
                  case 15:
                  case "end":
  ...
  _proto.findDocumentsById = /*#__PURE__*/function () {
    var _findDocumentsById = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(ids, deleted) {
      var _this2 = this;
      var state, ret;
      return _regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          ...
          case 3:
            ...
            ret = {};
            _context4.next = 7;
            return state.dexieDb.transaction('r', state.dexieTable, state.dexieDeletedTable, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
              var docsInDb;
              return _regeneratorRuntime.wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.next = 3;
                    return getDocsInDb(_this2.internals, ids);
                  case 3:
  ...
  _proto.count = /*#__PURE__*/function () {
    var _count = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(preparedQuery) {
      var result;
      return _regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return dexieCount(this, preparedQuery);
          case 2:
  ...
  _proto.getChangedDocumentsSince = /*#__PURE__*/function () {
    var _getChangedDocumentsSince = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(limit, checkpoint) {
      var _this3 = this;
        ...
        while (1) switch (_context7.prev = _context7.next) {
          ...
          case 5:
            ...
            return Promise.all([state.dexieTable, state.dexieDeletedTable].map( /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(table) {
  ...
  _proto.cleanup = /*#__PURE__*/function () {
    var _cleanup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee10(minimumDeletedTime) {
      var _this4 = this;
      var state;
      return _regeneratorRuntime.wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            _context10.next = 6;
            return state.dexieDb.transaction('rw', state.dexieDeletedTable, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9() {
  ...
  _proto.resolveConflictResultionTask = /*#__PURE__*/function () {
    var _resolveConflictResultionTask = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee11(_taskSolution) {
