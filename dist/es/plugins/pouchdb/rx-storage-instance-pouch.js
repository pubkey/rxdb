...
export var RxStorageInstancePouch = /*#__PURE__*/function () {
  ...
  _proto.remove = function remove() {
    try {
      ...
      OPEN_POUCH_INSTANCES["delete"](_this2.internals.pouchInstanceId);
  ...
  _proto.bulkWrite = function bulkWrite(documentWrites, context) {
    try {
      ...
      var writeDocs = documentWrites.map(function (writeData) {
        ...
        var storeDocumentData = rxDocumentDataToPouchDocumentData(_this3.primaryPath, writeData.document);
                ...
                var _temp3 = function () {
                  if (resultRow.error) {
                    ...
                    var err = {
                      ...
                      writeRow: writeRow,
                      documentInDb: pouchDocumentDataToRxDocumentData(_this3.primaryPath, previousDoc)
                    };
                    ...
                    _pushObj = pouchSwapIdToPrimary(_this3.primaryPath, _pushObj);
