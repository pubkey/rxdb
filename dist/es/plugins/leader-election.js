...
var LeaderElector = function () {
    ...
    LeaderElector.prototype.die = function die() {
    ...
    LeaderElector.prototype.waitForLeadership = function waitForLeadership() {
        var _this = this;
    ...
    LeaderElector.prototype.destroy = function destroy() {
