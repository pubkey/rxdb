...
export var RxStorageKeyObjectInstanceLoki = /*#__PURE__*/function () {
  function RxStorageKeyObjectInstanceLoki(databaseName, collectionName, internals, options, databaseSettings, broadcastChannel) {
    var _this = this;
  ...
  _proto.bulkWrite = /*#__PURE__*/function () {
    var _bulkWrite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(documentWrites) {
      ...
      var localState, collection, startTime, ret, writeRowById;
          ...
          switch (_context4.prev = _context4.next) {
            ...
            case 11:
              ...
              documentWrites.forEach(function (writeRow) {
                ...
                var newRevision = newRevHeight + '-' + createRevision(writeRow.document, true);
...
function _createLokiKeyValueLocalState() {
  _createLokiKeyValueLocalState = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(params, databaseSettings) {
    var databaseState, collectionOptions, localCollectionName, collection, changesCollectionName, changesCollectionOptions, changesCollection;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 3:
            ...
            localCollectionName = params.collectionName + CHANGES_LOCAL_SUFFIX;
            collection = databaseState.database.addCollection(localCollectionName, collectionOptions);
            databaseState.openCollections[localCollectionName] = collection;
            changesCollectionName = params.collectionName + CHANGES_LOCAL_SUFFIX + CHANGES_COLLECTION_SUFFIX;
...
export function createLokiKeyObjectStorageInstance(_x8, _x9) {
  return _createLokiKeyObjectStorageInstance.apply(this, arguments);
}

function _createLokiKeyObjectStorageInstance() {
  _createLokiKeyObjectStorageInstance = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(params, databaseSettings) {
    ...
    return _regeneratorRuntime.wrap(function _callee9$(_context9) {
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 5:
            instance = new RxStorageKeyObjectInstanceLoki(params.databaseName, params.collectionName, internals, params.options, databaseSettings, params.broadcastChannel);
