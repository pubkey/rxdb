...
import { ensureNotFalsy, PROMISE_RESOLVE_VOID, randomCouchString } from './util';
...
export var RxStorageMessageChannel = /*#__PURE__*/function () {
  ...
  _proto.createStorageInstance = function createStorageInstance(params) {
    try {
      ...
      var waitForOkPromise = firstValueFrom(messages$);
...
export var RxStorageInstanceMessageChannel = /*#__PURE__*/function () {
  ...
  _proto2.requestRemote = function requestRemote(methodName, params) {
    try {
      ...
      var responsePromise = firstValueFrom(_this5.internals.messages$.pipe(filter(function (msg) {
...
export function getRxStorageMessageChannel(settings) {
 ...
 */
export function exposeRxStorageMessageChannel(settings) {
