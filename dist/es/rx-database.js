...
export var RxDatabase = function () {
    ...
    RxDatabase.prototype.dangerousRemoveCollectionInfo = function dangerousRemoveCollectionInfo() {
    ...
    RxDatabase.prototype._ensureStorageTokenExists = function () {
     ...
     * @return {Promise}
     */
    RxDatabase.prototype.waitForLeadership = function waitForLeadership() {
    ...
    RxDatabase.prototype._removeAllOfCollection = function _removeAllOfCollection(collectionName) {
        var _this4 = this;
