...
export function startReplicationDownstream(state) {
  ...
  function _downstreamResyncOnce() {
    _downstreamResyncOnce = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
            ...
            return _regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  forkStateDocData = forkStateFullDoc ? writeDocToDocState(forkStateFullDoc) : undefined;
                ...
                case 6:
                  isAssumedMasterEqualToForkStatePromise = !assumedMaster || !forkStateDocData ? PROMISE_RESOLVE_FALSE : state.input.conflictHandler({
                ...
                case 9:
                  ...
                  return _context.abrupt("return", PROMISE_RESOLVE_VOID);
                case 13:
                  areStatesExactlyEqualPromise = !forkStateDocData ? PROMISE_RESOLVE_FALSE : state.input.conflictHandler({
                ...
                case 20:
                   ...
                   */
                  if (masterState._rev) {
                    nextRevisionHeight = !forkStateFullDoc ? 1 : parseRevision(forkStateFullDoc._rev).height + 1;
