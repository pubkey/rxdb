...
var _lokiSaveQueue = require("./loki-save-queue.js");
...
function stripLokiKey(docData) {
  ...
  var cloned = (0, _index.flatClone)(docData);
...
function getLokiDatabase(databaseName, databaseSettings) {
  return (0, _index.getFromMapOrCreate)(LOKI_DATABASE_STATE_BY_NAME, databaseName, () => {
    /**
    ...
    var databaseState = (async () => {
      ...
      var database = new _lokijs.default(databaseName + '.db', (0, _index.flatClone)(useSettings));
...
function getLokiSortComparator(_schema, query) {
  ...
  var fun = (a, b) => {
    ...
    sortOptions.find(sortPart => {
      ...
      var valueA = (0, _index.getProperty)(a, fieldName);
      var valueB = (0, _index.getProperty)(b, fieldName);
      if (valueA === valueB) {
        return false;
      } else {
        if (valueA > valueB) {
...
async function requestRemoteInstance(instance, operation, params) {
  ...
  var leaderElector = (0, _index.ensureNotFalsy)(instance.internals.leaderElector);
  ...
  var requestId = (0, _index.randomCouchString)(12);
...
async function handleRemoteRequest(instance, msg) {
  if (msg.type === LOKI_BROADCAST_CHANNEL_MESSAGE_TYPE && msg.requestId && msg.databaseName === instance.databaseName && msg.collectionName === instance.collectionName && !msg.response) {
    ...
    (0, _index.ensureNotFalsy)(instance.internals.leaderElector).broadcastChannel.postMessage(response);
  }
}
...
async function mustUseLocalState(instance) {
  ...
  if (leaderElector.isLeader && !instance.internals.localState) {
    ...
    return (0, _index.ensureNotFalsy)(instance.internals.localState);
  } else {
