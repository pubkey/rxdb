...
import { pickGridColumns } from '../src/grid-columns.ts';

/**
 * The pure helpers of the viewer page. They have no DOM and no RxDB,
 * so they are tested on their own, away from the rxdb suite.
 */
describe('db-viewer app', () => {
