 ...
 */
export declare function normalizeMangoQuery<RxDocType>(schema: RxJsonSchema<RxDocumentData<RxDocType>>, mangoQuery: MangoQuery<RxDocType>, 
/**
 * @performance
 ...
 */
skipSort?: boolean): FilledMangoQuery<RxDocType>;
/**
