...
import { cancelCreate, cancelEdit, checkRowHp, clearTable, isTableEmpty, openDialog, saveCreate, saveEdit, slug, tableRowExists } from "./shared.cy";

// This test will pass when run against a clean Quasar project

describe('Single Heroes Page/CRUD', () => {
  beforeEach(() => {
    cy.visit('/#/heroes');
